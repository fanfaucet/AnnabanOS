    ...
    return [
        {
            ...
            "risk_score": max(state.weather_risk, state.congestion),
        ...
        },
        {
            ...
            "congestion": state.congestion,
            "risk_score": max(max(0.0, state.weather_risk - 0.25), state.congestion),
            "ecological_zone_crossing": state.ecological_zone,
            "priority": state.priority,
        },
        {
            ...
            "risk_score": max(state.weather_risk, max(0.0, state.congestion - 0.10)),
